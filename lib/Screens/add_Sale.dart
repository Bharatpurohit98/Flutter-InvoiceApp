...
import 'package:invoiceapp/Screens/billeditems.dart';
...
class _SaleState extends State<Sale> {
  ...
  void dispose() {
    ...
    cusPhoneNumberContoller.dispose();
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                TextButton(
                  onPressed: () => Navigator.push(context,
                      MaterialPageRoute(builder: (context) => BilledItems())),
                  child: Text(
                    'Billed Items',
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  style: TextButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 171, 207, 248),
                    minimumSize: Size(400, 40),
                  ),
                ),
              ],
            ...
            TextButton(
                ...
                onPressed: () => {
                      if (_form1Key.currentState!.validate() &&
                          _formkey.currentState!.validate())
                        {
                          transactions.addTransaction(TransactionModel(
                              transactions.party, transactions.totalAmt)),
